  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed left-4 top-4 z-40 px-4 py-2 rounded-lg font-medium transition-all ${
          isOpen || activePath
      ...
      {/* Panel */}
      {isOpen && (
        <div className="fixed left-4 top-16 z-40 w-80 bg-gray-900/95 backdrop-blur rounded-xl shadow-2xl overflow-hidden border border-gray-700">
